...
ESTADO='OFF'
IP_MONITOR = '255.255.255.255' # IP de broadcast
PORTA_MONITOR = 9999
...
s.setsockopt(socket.SOL_SOCKET, socket.SO_BROADCAST, 1) # alterar o socket para aceitar broadcast
...
# Lógica para fazer o sensor identificar que o monitor está desligado
count = 0
while True:
    time.sleep(1)
    try:
